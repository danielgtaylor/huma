...
var (
	...
	MsgExpectedRFC5322EmailBare           = "expected string to be RFC 5322 email (addr-spec only, no display name)"
	...
	MsgExpectedRFC3986AbsoluteURI         = "expected string to be RFC 3986 absolute uri (non-empty scheme)"
